var list = {
	...
	'Summary': {	
		'Part 1 ~ Outlining the Problem': [
			...
			[ '<br>Chapter 0 ~ Absence','2-summary/1part/00absence' ],
		...
		'Part 2 ~ Outlining an Alternative Theory': [ 
			...
			[ '<br>Chapter 6 ~ Constraint','2-summary/2part/06constraint' ],
		...
		'Part 3 ~ Exploring the Implications': [       
			...
			[ '<br>Chapter 11 ~ Work','2-summary/3part/11work' ],
			...
			[ '<br>Epilogue','2-summary/3part/18epilogue' ]
		],
	},
	'Index & Glossary': {	
		'Expanded Index': [
